                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="create_lname"name="last_name"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="dob"id="create_dob"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <br><label for="experience" class="form-label">Total Experience<span
                                            class="text text-danger">*</span></label>
                                    <input type="text" class="form-control" name="experience" id="create_experience"
                                ...
                                <div class="col-md-6">
                                    <br> <label for="phone" class="form-label">Current Designation<span
                                            class="text text-danger">*</span></label>
                                    <input type="text" class="form-control"
                                        id="create_currentdesignation"name="currentdesignation"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <br> <label for="email" class="form-label">Email<span
                                            class="text text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <br /><label for="state" class="form-label">State<span
                                            class="text text-danger">*</span></label>
                                    <select type="text" class="form-control" name="state" id="create_state"
                                ...
                                <div class="col-md-6"><br>
                                    <label for="city" class="form-label">City<span
                                            class="text text-danger">*</span></label>
                                    <input type="text" class="form-control" name="city"id="create_city"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="create_pincode"name="pincode"
                                        placeholder="Enter Pincode">
                                </div>
                                <div class="col-md-6">
                                    <br> <label for="resume" class="form-label">Resume<span
                                            class="text text-danger">*</span></label>
                                    <input type="file" class="form-control" id="create_resume"name="resume"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <br><label for="postcode" class="form-label">Higher Qualification<span
                                            class="text text-danger">*</span></label>
                                    <input type="text" class="form-control"
                                        id="create_qualification"name="qualification" placeholder="Enter qualification">
                                    @error('qualification')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    <br> <label for="phone" class="form-label">Mobile No<span
                                            class="text text-danger">*</span></label>
                                    <input type="phone" class="form-control" id="create_phone"name="phone"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="education" id="create_education"
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1"><a href="{{ route('term') }}">
                                            <span style="margin-top:1px;">I agree to the terms and
