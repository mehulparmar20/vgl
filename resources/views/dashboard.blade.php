		  ...
		  <div class="col-12 col-sm-6 col-md-3">
			<div class="info-box">
			  ...
			  <div class="info-box-content">
				...
				<span class="info-box-number">  {{ $count['resume'] }}
        </span>
			  </div>
			</div>
		  </div>
		  <div class="col-12 col-sm-6 col-md-3">
			<div class="info-box mb-3">
			  ...
			  <div class="info-box-content">
				...
				<span class="info-box-number">{{ $count['sell'] }}
        </span>
			  </div>
			</div>
		  </div>
		  ...
		  <div class="col-12 col-sm-6 col-md-3">
			<div class="info-box mb-3">
			  ...
			  <div class="info-box-content">
				...
				<span class="info-box-number">{{ $count['job'] }}
        </span>
			  </div>
			</div>
		  </div>
            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Resume Submittor Rate</h3>
